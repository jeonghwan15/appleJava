...
public class map_study {
	...
	public static void main(String[] args) {
		...
		hash.put("서종우", "짝꿍머해요?");
		hash.put("남기현", "언제까지 잘꺼야???");
		hash.put("김민수", "쉬었다 올게요");
...
//		val.add("아하");
		...
		System.out.println( hash.containsKey("김민자") ); // key와 일치하는 값 존재 여부
		System.out	.println( hash.containsValue("영상:?일일웹툰..?") ); //value 존재여부
...
//		 TreeMap : 범위검색, 이진트리 구조를 사용하기 때문에 기본 정렬을 유지, 검색 시간은 
//                 데이터 양에 비례한다.
