...
////		System.out.println( ch );
		...
		// 6. 문자열 변경(치환) - replace()
		String temp = word.replace("banana cha cha", "rescue tayo");
		...
		// 11. String 참조변수가 반값인지 확인 ( 문자열이 있냐 없냐 ) - isEmpty()
		System.out.println( word.isEmpty() );
		
		// 12. 문자열에 특정 문자 도는 문자열 포함 여부 - contains()
		System.out.println( temp.contains("원숭이") );
		
		// 13. 특정 문자로 시작, 끝나는지 검사 - startWith(), endWith()
		System.out.println( wordd.startWith("내가"));
